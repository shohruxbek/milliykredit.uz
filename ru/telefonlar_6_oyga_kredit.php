...
<html lang="ру">
    <head>
       ...
       <title>Milliy kredit - 6 месяцев кредит без банк</title>
        ...
        <section class="solid_banner_area">
            <div class="container">
                <div class="solid_banner_inner">
                    <h3>Телефоны на 6 месяцев *кредит без банк</h3>
                    <ul>
                            ...
                            <div class="l_product_item client">
                                ...
                                <div class="l_p_text">
                                   <ul>
                                    ...
                                    <h5><?=$narx?><sup>000</sup><span> сум в месяц</span></h5>
                                </div>
                            </div>
                        </div>
                        <?php endforeach?>
       ...
       $narx=ceil($narx);
                        ...
                        <div class="col-lg-2 col-sm-4">
                            <div class="l_product_item client">
                                ...
                                <div class="l_p_text">
                                   <ul>
                                        <li><a class="add_cart_btn" href="help.php?id=<?=$narx?>">Узнать больше...</a></li>
                                        
                                    </ul>
                                    <h4><p class="text-capitalize"><?=$user['model']?> <?=$user['nom']?></p></h4>
                                    <h5><?=$user['narx']?><sup>000</sup><span> сум<p>в месяц</p></span></h5>
                                </div>
                            </div>
                        </div>
                        <?php endforeach?>
