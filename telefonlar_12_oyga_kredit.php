...
<head>
	...
	<title>Milliy kredit - 12 oyga bank-siz kredit</title>
	...
	<section class="solid_banner_area">
		<div class="container">
			<div class="solid_banner_inner">
				<h3>Telefonlar 12 oyga *bank-siz kredit</h3>
				<ul>
					<li><a href="index.php">Bosh menyu</a></li>
					<li><a href="telefonlar_6_oyga_kredit.php">telefonlar</a></li>
                ...
                <?=$user['info']?></h2>
                                ...
                                <div class="l_p_text">
                                   <ul>
                                    ...
                                    <h4><p class="text-capitalize"><?=$user['nom']?></p></h4>
