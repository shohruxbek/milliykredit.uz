...
$komp = "SELECT * FROM `user` WHERE `turkum` LIKE 'kompyuter'";//"SELECT * FROM user";
                      ...
                      <ul class="navbar-nav">
                          ...
                          <li class="nav-item dropdown submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="#sam">Asus</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#art">HP</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#hit">Aser</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#lg">Lenovo</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown submenu">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="container">
                <div class="solid_banner_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="kompyuter.php">KOMPYUTERLAR</a></li>
