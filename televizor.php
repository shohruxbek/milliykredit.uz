...
$komp = "SELECT * FROM `user` WHERE `turkum` LIKE 'televizor'";//"SELECT * FROM user";
                      ...
                      <ul class="navbar-nav">
                          ...
                          <li class="nav-item dropdown submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#art">&nbsp;&nbsp;Aartel</a></li>
            ...
            <div class="container">
                <div class="solid_banner_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="televizor.php">Televizorlar</a></li>
